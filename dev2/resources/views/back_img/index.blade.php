...
<head>
	...
	<title>背景画像管理画面</title>
	
	<script src="{{ asset('/js/app.js') }}" defer></script>
	<script src="{{ $crud_base_js . $ver_str }}" defer></script>
	<script src="{{ asset('/js/BackImg/index.js')  . $ver_str }}" defer></script>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">背景画像管理画面</li>
  </ol>
</nav>
...
<div class="cb_func_line">
	...
	<!-- 検索条件入力フォーム -->
	<form action="" class="form_kjs" id="back_imgIndexForm" method="post" accept-charset="utf-8">
		
		<?php $cbh->inputKjMain('kj_main','',null,'背景画像名、備考を検索する');?>
		...
		// --- CBBXS-2004
		$cbh->inputKjId(); 
		$cbh->inputKjText('kj_back_img_name','背景画像名');
	...
	<div id="main_tools" style="margin-bottom:10px;margin-top:4px">
		<div style="display:inline-block;width:75%; ">
			<?php 
				...
				// CSVエクスポート機能
	 			$csv_dl_url =  'back_img/csv_download';
...
<!-- 一覧テーブル -->
<table id="back_img_tbl" class="table table-striped table-bordered table-condensed" style="display:none;margin-bottom:0px">
...
<table id="crud_base_forms">
	...
	<tr id="ajax_crud_new_inp_form" class="crud_base_form" style="display:none;padding-bottom:60px"><td colspan='5'>
		...
		<div class="cbf_inp_wrap">
			<div class='cbf_inp' >背景画像名: </div>
			<div class='cbf_input'>
				<input type="text" name="back_img_name" class="valid " value=""  maxlength="255" title="255文字以内で入力してください" />
				<label class="text-danger" for="back_img_name"></label>
			</div>
		</div>
